...
<main role="main">
    ...
    <p id="plugin_summary"><?php /* //translators: "you have '3 plugins' installed and '1' activated" */
        yourls_se('You currently have <strong>%1$s</strong> installed, and <strong>%2$s</strong> activated', $plugins_count, $count_active); ?></p>
    ...
    <script type="text/javascript">
        ...
        $('#toggle_plugins').css({
            'background': 'transparent url("../images/filter.gif") top left no-repeat',
